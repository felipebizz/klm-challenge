package com.challenge.klm.statistic;

public class StatisticReport {

    private final long requestCount, request200Count,
            request4XXCount, request5XXCount, totalResponseTimeMillis,
            avgResponseTimeMillis, maxResponseTimeMillis, minResponseTimeMillis;
